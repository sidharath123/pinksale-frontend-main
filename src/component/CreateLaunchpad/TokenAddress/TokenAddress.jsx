    ...
    <div className='container'>
      <div className='sub-container'>
        ...
        <div className='chechboxDiv'>
          ...
          <Checkbox onChange={onChange}>5% BNB raised only <span className='pool'>(Recommended)</span></Checkbox>
        ...
        <div className='req-footer'>
          <p>For auto listing, after you finalize the pool your token will be auto listed on DEX.</p>
        </div>
